...
namespace DeaLoux.CoreSystems.Audio
{
    ...
    public class SoundEmitter : MonoBehaviour
    {
        ...
        public void FadeInPlay(AudioClip musicClip, AudioConfigurationSO settings, float duration, float startTime = 0f, bool hasToLoop = false, Vector3 position = default)
        {
            PlayAudioClip(musicClip, settings, hasToLoop, position);
        ...
        public float FadeOut(float duration)
        {
